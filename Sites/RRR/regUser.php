...
if(!isset($username))
	die(header("location:registration.php?loginFailed=true&reason=usernameblank"));

if($pass1 != $pass2)
    die(header("location:registration.php?loginFailed=true&reason=passwordmismatch"));
...
{
die(header('Location: registration.php#signup'));
}
mysql_close($con);
